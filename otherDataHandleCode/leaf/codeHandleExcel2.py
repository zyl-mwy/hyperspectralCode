...
dirListSoil = os.listdir(r'E:\my_project\hyperspectralData\medician\soil\drawRigion\runs\labelme2coco\hyperspectralDataSplit')[::-1]
print(dirListSoil)
for i in range(my_array.shape[0]):
    # my_array[i, 1] = dirListLeaf[2*i][:-4]
    my_array[i, 2] = dirListSoil[4*(i//48)+2][:-4]
    my_array[i, 3] = dirListSoil[4*(i//48)][:-4]
# print(my_array)
...
#             na_rep='我是空值')     # 空值的显示
data_df.to_excel('test3.xlsx')     # 空值的显示
