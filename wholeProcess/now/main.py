...
test(train_dataset, model, device, criterion, criterion1, '训练集')
test(val_dataset, model, device, criterion, criterion1, '验证集')
test(test_dataset, model, device, criterion, criterion1, '测试集')
